...
export default class ChargebeePayments extends Component<CBState> {
  state: CBState;
  cardRef: any = React.createRef();
        ...
        <div className="ex1-wrap">
          <div className="ex1-fieldset">
            <div className="ex1-field">
              ...
              />
              <label className="ex1-label">Name on Card</label>
            ...
            <CardComponent
              ...
              fonts={fonts}
              onKeyPress={(event: any) => console.log(event)}
            >
              <div className="ex1-field">
